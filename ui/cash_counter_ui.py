...
class Ui_CashCounter(object):
    def setupUi(self, CashCounter):
        ...
        self.lb_dollars_remove = QLabel(self.grp_coins_remove)
        self.lb_dollars_remove.setObjectName(u"lb_dollars_remove")
        self.lb_dollars_remove.setMinimumSize(QSize(75, 0))
        self.lb_dollars_remove.setMaximumSize(QSize(75, 16777215))
        self.lb_dollars_remove.setFont(font2)

        self.horizontalLayout_31.addWidget(self.lb_dollars_remove)

        self.le_dollars_remove = QLineEdit(self.grp_coins_remove)
        self.le_dollars_remove.setObjectName(u"le_dollars_remove")
        self.le_dollars_remove.setMinimumSize(QSize(60, 0))
        self.le_dollars_remove.setMaximumSize(QSize(60, 16777215))
        self.le_dollars_remove.setFont(font2)
        self.le_dollars_remove.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.horizontalLayout_31.addWidget(self.le_dollars_remove)

        self.lb_dollars_amt_remove = QLabel(self.grp_coins_remove)
        self.lb_dollars_amt_remove.setObjectName(u"lb_dollars_amt_remove")
        self.lb_dollars_amt_remove.setMinimumSize(QSize(60, 0))
        self.lb_dollars_amt_remove.setMaximumSize(QSize(60, 16777215))
        self.lb_dollars_amt_remove.setFont(font2)
        self.lb_dollars_amt_remove.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)

        self.horizontalLayout_31.addWidget(self.lb_dollars_amt_remove)
        ...
        self.lb_starting_cash.setMinimumSize(QSize(85, 35))
        self.lb_starting_cash.setMaximumSize(QSize(85, 35))
        ...
        self.dbl_starting_cash.setMinimumSize(QSize(0, 25))
        self.dbl_starting_cash.setMaximumSize(QSize(16777215, 25))
        self.dbl_starting_cash.setFocusPolicy(Qt.FocusPolicy.WheelFocus)
        ...
        self.verticalLayout = QVBoxLayout(self.dlg_menu)
        self.verticalLayout.setSpacing(10)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 10, 0, 10)
        self.pb_next_page = QPushButton(self.dlg_menu)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Icons/arrow-right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_next_page.setIcon(icon1)
        self.pb_next_page.setIconSize(QSize(25, 25))

        self.verticalLayout.addWidget(self.pb_next_page)

        self.pb_previous_page = QPushButton(self.dlg_menu)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/arrow-left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.pb_cancel = QPushButton(self.dlg_menu)
    ...
    def retranslateUi(self, CashCounter):
        ...
        self.lb_dollars_remove.setText(QCoreApplication.translate("CashCounter", u"Dollars:", None))
        self.lb_dollars_amt_remove.setText(QCoreApplication.translate("CashCounter", u"$ 0.00", None))
