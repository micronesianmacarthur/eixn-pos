...
class Ui_CreateCategoryDialog(object):
    def setupUi(self, CreateCategoryDialog):
        ...
        self.pb_category_modify.setMinimumSize(QSize(0, 35))
        self.pb_category_modify.setMaximumSize(QSize(16777215, 35))
        icon1 = QIcon()
        icon1.addFile(u":/Icons/edit.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_category_modify.setIcon(icon1)
        self.pb_category_modify.setIconSize(QSize(16, 16))
        ...
        self.pb_category_delete.setMinimumSize(QSize(0, 35))
        self.pb_category_delete.setMaximumSize(QSize(16777215, 35))
        icon2 = QIcon()
        icon2.addFile(u":/Icons/trash.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_category_delete.setIcon(icon2)
        self.pb_category_delete.setIconSize(QSize(16, 16))
        ...
        self.pb_category_cancel.setMinimumSize(QSize(0, 35))
        self.pb_category_cancel.setMaximumSize(QSize(16777215, 35))
        icon3 = QIcon()
        icon3.addFile(u":/Icons/cross.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pb_category_cancel.setIcon(icon3)
        self.pb_category_cancel.setIconSize(QSize(16, 16))
